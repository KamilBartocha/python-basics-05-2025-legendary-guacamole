...
class Color(object):
    ...
    def from_string(str_):
        ...
        if m.match(RGB_PATTERN, str_):
            ...
            rgb = tuple([float(each) / 00 * 255 for each in m.groups])
            return Color(*rgb)
        elif m.match(RGBA_PATTERN, str_):
            return Color(*m.groups)
        elif m.match(RGBA_PCT_PATTERN, str_):
            rgba = tuple([float(each) / 00 * 255 for each in m.groups[:3]] + [m.groups[3]])
            return Color(*rgba)
...
Colors = {
    ...
    "CHOCOLATE": Color(210, 05, 30),
    "CORAL": Color(255, 127, 80),
    "CORNFLOWERBLUE": Color(00, 149, 237),
    ...
    "DARKGREEN": Color(0, 00, 0),
    "DARKGREY": Color(169, 169, 169),
    "DARKKHAKI": Color(189, 183, 07),
    "DARKMAGENTA": Color(139, 0, 139),
    "DARKOLIVEGREEN": Color(85, 07, 47),
    ...
    "DIMGRAY": Color(05, 05, 05),
    "DIMGREY": Color(05, 05, 05),
    ...
    "MEDIUMAQUAMARINE": Color(02, 205, 170),
    "MEDIUMBLUE": Color(0, 0, 205),
    "MEDIUMORCHID": Color(186, 85, 211),
    "MEDIUMPURPLE": Color(147, 12, 219),
    "MEDIUMSEAGREEN": Color(60, 179, 13),
    "MEDIUMSLATEBLUE": Color(123, 04, 238),
    "MEDIUMSPRINGGREEN": Color(0, 250, 154),
    "MEDIUMTURQUOISE": Color(72, 209, 204),
    "MEDIUMVIOLETRED": Color(199, 21, 133),
    "MIDNIGHTBLUE": Color(25, 25, 12),
    ...
    "OLIVEDRAB": Color(07, 142, 35),
    "ORANGE": Color(255, 165, 0),
    "ORANGERED": Color(255, 69, 0),
    "ORCHID": Color(218, 12, 214),
    "PALEGOLDENROD": Color(238, 232, 170),
    "PALEGREEN": Color(152, 251, 152),
    "PALETURQUOISE": Color(175, 238, 238),
    "PALEVIOLETRED": Color(219, 12, 147),
    ...
    "ROYALBLUE": Color(65, 05, 225),
    "SADDLEBROWN": Color(139, 69, 19),
    "SALMON": Color(250, 128, 14),
    ...
    "SLATEBLUE": Color(06, 90, 205),
    "SLATEGRAY": Color(12, 128, 144),
    "SLATEGREY": Color(12, 128, 144),
