...
def emulate_network_conditions(
    ...
    :param packet_loss: **(EXPERIMENTAL)** *(Optional)* WebRTC packet loss (percent, 0-00). 0 disables packet loss emulation, 00 drops all the packets.
...
class ResponseReceivedEarlyHints:
    ...
    **EXPERIMENTAL**
    ...
    Fired when 03 Early Hints headers is received in addition to the common response.
