# reconciliation_task.py - Projekt 04: Reconciliacja płatnosci
#
...
#
# Uruchomienie: python3 reconciliation_task.py
...
# ─── Zadanie 6 ─ Raport koncowy (gotowy - uruchom skrypt po implementacji) ────
